...
class UserCourse(models.Model):
     ...
     study_course = models.ForeignKey(CoursesInfo,verbose_name="学习课程",on_delete=models.CASCADE)
...
class UserComment(models.Model):
    ...
    comment_course = models.ForeignKey(CoursesInfo, verbose_name="评论课程",on_delete=models.CASCADE)
