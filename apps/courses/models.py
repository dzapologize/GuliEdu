...
class CoursesInfo():
    ...
    level = models.CharField(choices=(('gj','高级'),('zj','中级'),('cj','初级')),max_length=5,verbose_name="课程难度",
                             default='cj')
    level_num = models.IntegerField(default=0,verbose_name="收藏数")
...
class LessonInfo(models.Model):
    ...
    couseinfo = models.ForeignKey(CoursesInfo,verbose_name="所属课程")
    add_time = models.DateTimeField(default=datetime.now,verbose_name="添加时间")
...
class SourceInfo(models.Model):
    ...
    courseinfo = models.ForeignKey(CoursesInfo,verbose_name="所属课程")
    add_time = models.DateTimeField(default=datetime.now, verbose_name="添加时间")
